      ...
      <div className="header-container">
        <Link to={`/`}>
          <div className="logo-section">
            <FontAwesomeIcon className="logo-icon" icon={faBoxesPacking} />
            <h2>ReactoTech</h2>
          </div>
        </Link>
