  ...
  const settingTheme = (theme) => {
    if (theme === "light") {
      document.documentElement.style.cssText =
        "--main-color: #FFFFFF; --secondary-color: #F8FAFB; --btn-solid-color: #FFFFFF; --main-text-color: #272C45; --border-color: #E4E4E7; --btn-addCart: rgba(81, 69, 229, 0.9); --background-gradient-1:#f1f1f1; --background-gradient-2: #f1f1f1; --bacground-blur-color: #FAFAFB; --searchbar-color: #FFFFFF;";
    } else {
      document.documentElement.style.cssText =
